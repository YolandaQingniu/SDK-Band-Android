...
* 在你的module的根目录下的**build.gradle**添加依赖
	...
	dependencies {
	        ...
	        compile 'com.github.YolandaQingniu:SDK-Band-Android:1.0.0'
	}
	```
	
### Eclipse
* 下载最新的[jar和so库](https://github.com/YolandaQingniu/SDK-Band-Android/releases/download/1.0.0/qnwristsdk-1.0.0-Android.zip)，导入下载的`jar和so库`
