...
public class SettingActivity extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener, View.OnClickListener {
    ...
    private boolean checkInfo() {
        ...
        try {
            ...
            e.printStackTrace();
            ToastMaker.show(this, getResources().getString(R.string.input_weight_hint));
            return true;
        }
        int scanTime = 0;
        try {
        ...
        if (userId.isEmpty()) {
            ...
            ToastMaker.show(this,getResources().getString(R.string.input_date_time));
            return true;
            ...
            ToastMaker.show(this,getResources().getString(R.string.set_scale_unit));
            return true;
        }
